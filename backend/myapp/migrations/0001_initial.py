# Generated by Django 4.1.13 on 2024-03-02 22:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ch_turmas_teorico', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_turmas_pratico', models.DecimalField(decimal_places=2, max_digits=5)),
                ('docentes_envolvidos_e_cargas_horarias', models.JSONField()),
                ('ch_total', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
            options={
                'managed': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semestre', models.IntegerField()),
                ('ch_semanal_orientacao', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_semanal_coorientacao', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_semanal_supervisao', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_semanal_preceptoria_e_ou_tutoria', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('semestre', models.IntegerField()),
                ('ch_semanal_graduacao', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_semanal_pos_graduacao', models.DecimalField(decimal_places=2, max_digits=5)),
                ('ch_semanal_total', models.DecimalField(decimal_places=2, max_digits=5)),
            ],
            options={
                'managed': False,
