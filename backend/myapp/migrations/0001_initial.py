# Generated by Django 4.1.13 on 2024-04-04 01:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('curso', models.CharField(max_length=100)),
                ('tipo', models.CharField(max_length=50)),
                ('nivel', models.CharField(choices=[('GRA', 'GRA'), ('POS', 'POS')], default='GRA', max_length=50)),
                ('ch_semanal_primeiro_semestre', models.FloatField()),
                ('ch_semanal_segundo_semestre', models.FloatField()),
                ('relatorio_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.relatoriodocente')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel', models.CharField(choices=[('GRA', 'GRA'), ('POS', 'POS')], default='GRA', max_length=10)),
