# Generated by Django 4.1.13 on 2024-03-06 21:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relatorio', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.relatoriodocente')),
            ],
        ),
        migrations.CreateModel(
            name='Usuario',
            fields=[
                ...
                ('regime_de_trabalho', models.CharField(choices=[('exclusivo', 'Dedicação Exclusiva'), ('integral', '40h'), ('parcial', '20h')], max_length=50)),
                ('titulacao', models.CharField(choices=[('graduacao', 'Graduação'), ('especializacao', 'Especialização'), ('mestre', 'Mestre'), ('doutor', 'Doutor')], max_length=100)),
